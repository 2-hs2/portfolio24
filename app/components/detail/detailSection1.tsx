...
const DetailSection1 = ({
  ...
  return (
    <section className="min-h-[67.5rem] h-max flex flex-col justify-between items-center p-[4rem] leading-normal mobile:min-h-[50.75rem] mobile:p-[3rem]">
      <div className="w-full flex items-center gap-8 font-notoSerifTibetan text-[1rem] mobile:text-[0.875rem] laptop:mb-[3rem] mobile:mb-[2rem]">
        <Image
      ...
      >
        <div className="flex flex-col gap-[3rem] laptop:flex-row mobile:gap-[2rem]">
